...
FullCorpus1<- bind_rows(
 ...
 plot_a <-FullCorpus1 %>%
      ggplot(aes(x = valence, y = energy, color = category, size = loudness)) +  geom_point() +   geom_jitter() + geom_smooth() + labs(x = "Valence", y = "Energy", title = "Energy and Valence Scatterplot")
...
plot_a <- FullCorpus1 |>
      ggplot(aes(x = valence, y = energy, color = category)) +  geom_point() +   geom_jitter() + geom_smooth() + labs(x = "Valence", y = "Energy", title = "Energy and Valence Scatterplot")
...
**Energy and Valence Scatterplot**
...
**Histogram of Dance-ability**

This histogram shows how danceable the two artists discography actually are. 
...
**Dendrogram**
This is a dendrogram attempting to make groups and connectons between the tracks on both Paul Simons latest album and Simon and Garfunkels first album in order to fully understand the contrast between the begining of their duo career and the end of Pauls solo career. Based off of this graph it is clear that ___. 
...
### General Information; key and tempo
```{r , echo=FALSE}
PaulSimon<- get_playlist_audio_features("","2WzHYvLkaCRZDjsB04UfSE")
SimonAndGarfunkel<-get_playlist_audio_features("","22geZ3piYiEEYuvRoZ51op")
 ...
 **Tempograms**
 ...
 These Tempograms are here to track how AI measures the tempo of a recording through least and most popular tracks in both artists discographies. 
...
### New Tab 1.2: Tempogram, compared to Timbre SSMs, The Boxer
```{r , echo=FALSE}
...
TheBoxerSG |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "theBoxerSG", y = "TheBoxerSG")

TheBoxerSGLive <-
     get_tidy_audio_analysis("0Fj8qJmcmec4IOvBmGISnF?si=c21b9f7aecf545ef") |>
     select(segments) |>
     unnest(segments) |>
     select(start, duration, timbre)
...
TheBoxerSGLive |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "theBoxerSGLive", y = "TheBoxerSGLive")
...
TheBoxerPLive |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "theBoxerPLive", y = "TheBoxerPLive")


```
***

This page contains a tempogram of the offical recording of the Boxer, by Simon and Garfunkel as well as three different Self Similarity Matrix of different versions of the song, one live by Simon and Garfunkel and one live recording by Paul Simon alone. analysis____. 
...
Im not fully sure what to say about this yet however I am interested in the extreme outliers in this data set and in turn I hope to be able to make some type of connection explaining why they are all Simon and Garfunkel tracks. For this reason I feel I need to label outliers on this graph. I hope to be able to make better sense of the standard deviation component because I dont fully understand!
